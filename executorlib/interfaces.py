...
class LocalExecutor:
    ...
    Examples:
        ```
        >>> import numpy as np
        >>> from executorlib.interfaces import LocalExecutor
        >>>
        >>> def calc(i, j, k):
...
class SlurmSubmissionExecutor:
    ...
    Examples:
        ```
        >>> import numpy as np
        >>> from executorlib.interfaces import SlurmSubmissionExecutor
        >>>
        >>> def calc(i, j, k):
        >>>     from mpi4py import MPI
        >>>     size = MPI.COMM_WORLD.Get_size()
...
class FluxAllocationExecutor:
    ...
    Examples:
        ```
        >>> import numpy as np
        >>> from executorlib.interfaces import FluxAllocationExecutor
        >>>
        >>> def calc(i, j, k):
        >>>     from mpi4py import MPI
        >>>     size = MPI.COMM_WORLD.Get_size()
...
class FluxSubmissionExecutor:
    ...
    Examples:
        ```
        >>> import numpy as np
        >>> from executorlib.interfaces import FluxSubmissionExecutor
        >>>
        >>> def calc(i, j, k):
        >>>     from mpi4py import MPI
        >>>     size = MPI.COMM_WORLD.Get_size()
