from pympipool.share.pool import Pool as PoolBase, MPISpawnPool as MPISpawnPoolBase
...
class MPISpawnPool(MPISpawnPoolBase):
    """
    ...
    def __init__(
        ...
        super(MPISpawnPoolBase, self).__init__()
        command_lst = get_parallel_subprocess_command(
            port_selected=self._interface.bind_to_random_port(),
            cores=max_ranks,
